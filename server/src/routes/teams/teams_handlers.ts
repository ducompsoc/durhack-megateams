...
class TeamHandlers {
  ...
  async listTeamsAsAnonymous(request: Request, response: Response) {
  ...
  @requireUserIsAdmin
  async patchTeamAsAdmin(request: Request, response: Response) {
  ...
  @requireUserIsAdmin
  async createTeamAsAdmin(request: Request, response: Response, next: NextFunction) {
    next();
  }

  @requireLoggedIn
  async createTeamAsHacker(request: Request, response: Response) {
  ...
  @requireUserIsAdmin
  async addUserToTeamAsAdmin(request: Request, response: Response) {
    throw new createHttpError.NotImplemented();
  }

  @requireUserIsAdmin
  async removeUserFromTeamAsAdmin(request: Request, response: Response) {
    throw new createHttpError.NotImplemented();
  }
